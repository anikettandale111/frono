  ...
  public function cat_product(Request $request)
    ...
    if($nearbystore->del_range >= $nearbystore->distance)  {           
       $prod =  DB::table('store_products')
          ...
          ->select('product.product_name','product.product_id','product.cat_id','product.product_image','product.hide')
          ->groupBy('product.product_name','product.product_id','product.cat_id','product.product_image','product.hide')
        // ->orderByRaw('-product.seq DESC')
                ...
                $app = DB::table('store_products')
                 ->join ('product_varient', 'store_products.varient_id', '=', 'product_varient.varient_id')
                  ->join ('product', 'product_varient.product_id', '=', 'product.product_id')
                   ...
                   ->select('product_varient.*','product.*','store_products.price','store_products.mrp','store_products.store_id','store_products.stock','deal_product.deal_price')
            ->where('store_products.store_id', $nearbystore->store_id)
